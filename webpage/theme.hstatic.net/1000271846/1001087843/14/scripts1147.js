		...
		if(cart) {
			...
			jQuery.each(cart.items,function(i,item){
				...
				if(item.image != null)
					...
					tr.find('.item-image').html("<img src='//theme.hstatic.net/1000271846/1001087843/14/no_image.jpg?v=106'>");
...
function clone_item(product,i){
	...
	if ( product.image == null ) {
		item_product.find('img').attr('src','//theme.hstatic.net/1000271846/1001087843/14/no_image.jpg?v=106').attr('alt', product.url);
	} else {
...
$("#home-slider .owl-carousel .item").sort(asc_sort).appendTo('#home-slider .owl-carousel');
